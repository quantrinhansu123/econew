...
export default function AdminTrucksPage() {
  ...
  const internalOnly = location.pathname === '/fleet/internal-vehicles' || location.pathname === '/admin/trucks';
  ...
  useEffect(() => { void fetchDrivers(); if (internalOnly) void fetchHubs(); }, [internalOnly]);
