...
import { AlertTriangle, ArrowLeft, Building2, ChevronLeft, ChevronRight, Edit, Fuel, Gauge, Filter, GripVertical, Images, LayoutGrid, Loader2, Plus, Power, Search, Tag, Trash2, Truck as TruckIcon, User, X } from 'lucide-react';
...
import type { FilterOption, Truck, TruckFilters, TruckFormState, TruckListResponse } from './trucks/types';
...
type TruckTableColumnId = 'license_plate' | 'payload' | 'assignment' | 'fuel_consumption_limit' | 'status' | 'actions';
...
const emptyForm: TruckFormState = { license_plate: '', payload: '', driver_id: '', fuel_consumption_limit: '', status: 'AVAILABLE', bks: '', hub_id: '', vendor_id: '', document_image_urls: [] };
