...
import { AlertTriangle, ArrowLeft, Building2, ChevronLeft, ChevronRight, Edit, Fuel, Gauge, Filter, GripVertical, LayoutGrid, Loader2, Plus, Power, Search, Tag, Trash2, Truck as TruckIcon, User, X } from 'lucide-react';
...
const emptyForm: TruckFormState = { license_plate: '', payload: '', driver_id: '', fuel_consumption_limit: '', status: 'AVAILABLE', bks: '', hub_id: '', vendor_id: '' };
...
export default function AdminTrucksPage() {
  ...
  return (
    <div className="h-full min-h-0 flex flex-col gap-2">
      ...
      <AddEditTruckDialog isOpen={isFormOpen} isClosing={isFormClosing} isEditMode={isEditMode} isSubmitting={isSubmitting} onClose={closeForm} onSubmit={submitForm} formState={formState} setFormField={setFormField} statusOptions={statusOptions} internalOnly={formInternalMode} hubOptions={hubOptions} vendorOptions={vendorOptions.filter(option => option.value)} />
