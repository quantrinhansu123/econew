...
export interface VendorSummary { id?: string | number; code?: string | null; name?: string | null; }
export interface TripSummary { id?: string | number; trip_code?: string | null; code?: string | null; status?: string | null; start_hub_id?: string | number | null; end_hub_id?: string | number | null; start_hub?: HubSummary | null; end_hub?: HubSummary | null; departure_time?: string | null; arrival_time?: string | null; expected_arrival_time?: string | null; trip_cost?: number | string | null; fuel_cost?: number | string | null; other_costs?: number | string | null; driver_name?: string | null; driver_phone?: string | null; carrier_label?: string | null; manual_license_plate?: string | null; vendor_id?: string | number | null; vendor?: VendorSummary | null; driver?: UserSummary | null; truck?: { license_plate?: string | null; bks?: string | null; phone?: string | null; ten_lai_xe?: string | null; nha_xe?: string | null; vendor?: VendorSummary | null; driver?: UserSummary | null } | null; }
export type ManifestDispatchFields = Record<string, string | number | null | undefined>;
export interface ManifestWaybill { id: string | number; waybill_code?: string | null; sent_date?: string | null; created_at?: string | null; sender_info?: string | null; receiver_info?: string | null; receiver_phone?: string | null; receiver_address?: string | null; noi_dung?: string | null; note?: string | null; cod_amount?: number | string | null; weight?: number | string | null; length?: number | string | null; width?: number | string | null; height?: number | string | null; volumetric_weight?: number | string | null; payment_type?: string | null; current_state?: string | null; status?: string | null; cost_amount?: number | string | null; origin_hub_id?: string | number | null; dest_hub_id?: string | number | null; origin_hub?: HubSummary | null; dest_hub?: HubSummary | null; package_count?: number | string | null; remaining_packages?: number | string | null; order_total_packages?: number | string | null; trip_label?: string | null; noi_den?: string | null; the_tich_m3?: number | string | null; loading_position?: number | string | null; dispatch_fields?: ManifestDispatchFields | null; manifest_id?: string | number | null; delivery_photo_url?: string | null; delivery_preparation_status?: 'PENDING_CONFIRMATION' | 'READY' | 'SCHEDULED' | 'NEEDS_ACTION' | 'HOLD' | null; delivery_scheduled_at?: string | null; delivery_hold_reason?: string | null; delivery_preparation_note?: string | null; delivery_assignment_type?: 'INTERNAL' | 'PARTNER' | 'TECHNOLOGY' | 'CUSTOMER_PICKUP' | null; route_code?: string | null; last_mile_driver_name?: string | null; last_mile_license_plate?: string | null; last_delivery_failure_reason?: string | null; delivery_time?: string | null; delivered_at?: string | null; returned_at?: string | null; }
export interface LoadPlanningManifest { id: string | number; manifest_code?: string | null; code?: string | null; seal_code?: string | null; origin_hub_id?: string | number | null; dest_hub_id?: string | number | null; origin_hub?: HubSummary | null; dest_hub?: HubSummary | null; status?: string | null; waybill_count?: number | string | null; total_waybills?: number | string | null; total_packages?: number | string | null; total_weight?: number | string | null; weight_total?: number | string | null; processed_waybills?: number | string | null; delivered_waybills?: number | string | null; pending_delivery_waybills?: number | string | null; trip_id?: string | number | null; trip?: TripSummary | null; trips?: TripSummary[]; closed_at?: string | null; created_at?: string | null; closed_by?: UserSummary | null; created_by?: UserSummary | null; waybills?: ManifestWaybill[]; manifest_waybills?: Array<{ waybill_id?: string | number | null; loading_position?: number | string | null; dispatch_fields?: ManifestDispatchFields | null; waybill?: ManifestWaybill | null }>; note?: string | null; }
