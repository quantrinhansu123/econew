...
const meta: Partial<Record<DispatchSheetColumnId, DispatchSheetColumnMeta>> = {
  ...
  dv: { id: 'dv', fieldKey: 'dv', readOnly: true, minWidth: '58px' },
  matHang: { id: 'matHang', fieldKey: 'mat_hang', readOnly: true, minWidth: '180px' },
  noiTra: { id: 'noiTra', fieldKey: 'noi_tra', readOnly: true, minWidth: '130px' },
  ...
  tinhTrangGiaoHang: { id: 'tinhTrangGiaoHang', fieldKey: 'trang_thai_giao', readOnly: true, cellClass: 'bg-green-200', minWidth: '140px' },
  ngayHoanThanh: { id: 'ngayHoanThanh', fieldKey: 'ngay_hoan_thanh', readOnly: true, minWidth: '100px' },
  ...
  maVach: { id: 'maVach', readOnly: true, minWidth: '140px' },
  hinhAnh: { id: 'hinhAnh', readOnly: true, minWidth: '120px' },
