...
export const ORDER_BULK_TEMPLATE_NOTES: Partial<Record<OrderBulkFieldKey, string>> = {
  ...
  nguoiNhan: 'HCM tự nhảy; tỉnh khác bắt buộc nhập',
  dienThoaiNhan: 'HCM tự nhảy; tỉnh khác bắt buộc nhập',
  diaChiNhan: 'HCM tự nhảy; tỉnh khác bắt buộc nhập',
...
export const ORDER_BULK_COLUMNS: OrderBulkColumn[] = [
  ...
  { key: 'dienThoaiNhan', label: 'ĐT người nhận', required: true, sample: '0888727897' },
...
export const ORDER_BULK_INSTRUCTIONS = [
  ...
  'Tỉnh/Thành nhận là HCM: tự lấy người nhận, SĐT và địa chỉ kho HCM theo Mã KH. Tỉnh khác bắt buộc nhập theo từng đơn.',
