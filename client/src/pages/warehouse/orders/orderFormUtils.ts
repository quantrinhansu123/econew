...
function waybillToOrderFormBase(waybill: WaybillDetail, hubs: HubSummary[]): NewOrderFormState {
  ...
  return {
    ...
    dimensionFileUrl: waybill.dimension_file_url?.trim() || '',
    dimensionFileName: waybill.dimension_file_name?.trim() || '',
...
export function buildCreatePayload(form: NewOrderFormState, volumetricWeight: number) {
  ...
  return {
    ...
    dimension_file_url: form.dimensionFileUrl || undefined,
    dimension_file_name: form.dimensionFileName || undefined,
