...
const emptyForm: FundForm = { id: '', code: '', name: '', note: '', is_active: true };
...
export default function CashFundManagerDialog({ open, funds, onClose, onChanged }: Props) {
