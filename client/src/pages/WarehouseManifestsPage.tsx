...
export default function WarehouseManifestsPage() {
  ...
  const canCreateVendors = canDeleteExpenses;
  ...
  return (
    <div className="h-full min-h-0 flex flex-col gap-2">
      ...
      <ManifestDetailDialog isOpen={isDetailOpen} isClosing={isDetailClosing} isLoading={isDetailLoading} isSubmitting={isSubmitting} manifest={detailManifest} statusConfig={statusConfig} canManage={canManageManifest} canManageExpenses={canManageExpenses} canDeleteExpenses={canDeleteExpenses} canCreateVendors={canCreateVendors} openExpenseFormOnMount={openExpenseOnDetail} showHubDeliveryStatus={userHubView === 'HCM'} onClose={closeDetail} onRemoveWaybill={confirmRemoveWaybill} onUpdateDispatchFields={updateDetailDispatchFields} onUpdateExpectedArrival={updateExpectedArrival} />
