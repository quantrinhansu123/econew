...
export const moduleGroups: ModuleGroup[] = [
  {
    ...
    items: [
      ...
      { icon: AlertTriangle, title: 'Hàng đã tới bưu cục', description: 'Chỉ xe đã đến, tách theo bưu cục xuất phát Hà Nội và TP.HCM.', colorScheme: 'orange', path: '/warehouse/incoming', requiredRoleMask: WAREHOUSE_ROLES },
