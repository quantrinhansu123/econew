...
export const moduleGroups: ModuleGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Receipt, title: 'Phiếu thu chi', description: 'Lập thu chi hằng ngày theo sổ quỹ, NCC và loại chi phí.', colorScheme: 'teal', path: '/finance/cash-vouchers', requiredRoleMask: ACCOUNTANT | MANAGER_ROLES },
      ...
      { icon: ClipboardList, title: 'Nhật ký thu chi', description: 'Nhập và theo dõi toàn bộ thu chi theo quỹ, NCC và phân loại.', colorScheme: 'slate', path: '/finance/cash-journal', requiredRoleMask: ACCOUNTANT | MANAGER_ROLES },
      { icon: ClipboardList, title: 'Danh mục loại chi phí', description: 'Tạo và quản lý danh sách loại chi phí dùng chung cho toàn hệ thống.', colorScheme: 'purple', path: '/finance/expense-categories', requiredRoleMask: ACCOUNTANT | MANAGER_ROLES },
  ...
  },
  {
    ...
    items: [
      ...
      { icon: DatabaseBackup, title: 'Backup dữ liệu', description: 'Chọn bảng public Supabase để tải JSON hoặc đẩy lên khôi phục.', colorScheme: 'orange', path: '/admin/backup', requiredRoleMask: DIRECTOR, directorOnly: true },
