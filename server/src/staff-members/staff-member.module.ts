...
@Module({
  imports: [TypeOrmModule.forFeature([StaffMemberEntity, StaffDepartmentEntity, StaffAttendanceEntity, SalaryAdvanceEntity, StaffPayrollAdjustmentEntity, CashJournalEntryEntity, CashFundEntity])],
