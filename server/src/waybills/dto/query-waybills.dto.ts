...
export class QueryWaybillsDto {
  ...
  @ApiPropertyOptional({ description: 'all_orders — toàn bộ đơn; all_inventory — toàn bộ đơn tồn khả dụng, không giới hạn HUB' }) @IsOptional() @IsString() list_scope?: string;
